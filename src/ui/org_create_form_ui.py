...
# Form implementation generated from reading ui file 'ui/org_create_form.ui'
#
...
class Ui_CreateOrg(object):
    def setupUi(self, CreateOrg):
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.nameFill)
        self.codeLabel = QtWidgets.QLabel(CreateOrg)
        self.codeLabel.setObjectName("codeLabel")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.LabelRole, self.codeLabel)
        self.codeFill = QtWidgets.QLineEdit(CreateOrg)
        self.codeFill.setObjectName("codeFill")
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.codeFill)
    ...
    def retranslateUi(self, CreateOrg):
        ...
        self.formTitle.setText(_translate("CreateOrg", "Create your organization"))
        self.infoText.setText(_translate("CreateOrg", "Enter the required information about your organization below. The code is what the other users will use to join your organization. You will automatically be assigned as the admin of the organization."))
